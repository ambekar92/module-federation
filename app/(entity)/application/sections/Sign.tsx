        ...
        mainContent={
          <div>
            ...
            <div className='padding-2 bg-accent-cool-darker'>
              ...
              <Checkbox className='bg-accent-cool-darker attestation-checkbox' id={'sign-application'} name={'sign-application'} label={'I hereby certify that any information provided via my Username/Password pair has been reviewed by me personally, and is true and accurate.'} />
            </div>
          </div>
        }
      />
