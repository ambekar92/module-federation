          ...
          <SummaryBoxContent>
            ...
            <ul>
              <li>
                ...
                <Link
                  data-testid="my-samGovLinkStatusTracker"
              ...
              <li>
                ...
                SAM.gov{' '}
                <Link
                  data-testid="my-samGovLinkRegistration"
        ...
        <SummaryBox className={Styles.mb_default}>
          ...
          <SummaryBoxContent>
            <p>
              ...
              purposes. However, it is highly recommended that businesses obtain
              an Employer Identification Number (EIN). Applying for an EIN is
              simple and using your SSN for business can pose security and
              privacy risks. Please visit{' '}
