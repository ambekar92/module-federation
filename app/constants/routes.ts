...
export const RETURN_APPLICATION_TO_FIRM = '/return-application-to-firm';
export const RTF_REQUEST_ROUTE = '/rtf-requests';
export const RFI_REQUEST_ROUTE = '/rfi-requests';
