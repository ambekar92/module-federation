            ...
            <Grid row gap='md'>
              {textFieldKeys.map(key => (
                (key === 'firstName' || key === 'middleInitial' || key === 'lastName') && (
                  <Grid key={key} desktop={{col: key === 'lastName' && 5 || key === 'firstName' && 5 || key === 'middleInitial' && 2 || 12}} tablet={{col: key === 'lastName' && 12 || key === 'firstName' && 9 || key === 'middleInitial' && 3 || 12}} mobile={{col: 12}}>
