...
import { BusinessProfileType, IAccordionItem, IBusinessProfile } from '../utils/types'
...
function ValidateBusinessForm() {
  ...
  const onClickVerify = (e: React.MouseEvent<HTMLButtonElement>) => {
      ...
      content: (
        <div className="default-table">
          {businessProfile[uei].claimed ? (
            <Alert role="alert" type="success" heading="Claimed" headingLevel="h5" slim></Alert>
          ) : null}
          <Table bordered={false}>{validationTableContent(businessProfile[uei])}</Table>
          {!businessProfile[uei].claimed ? (
          ...
          <Grid mobile={{ col: 12 }}>
            <SummaryBox style={{ marginBottom: '1.25rem' }}>
              ...
              <SummaryBoxContent>
                ...
                <p>
									If any of the information here is incorrect, <b style={{ color: 'red' }}>STOP</b> now and go
									to{' '}
