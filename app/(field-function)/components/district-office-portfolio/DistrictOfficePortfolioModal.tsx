...
interface DistrictOfficePortfolioModalProps {
...
const DistrictOfficePortfolioModal: React.FC<DistrictOfficePortfolioModalProps> = ({
  modalRef,
  data,
  handleAction,
}) => {
...
export default DistrictOfficePortfolioModal
