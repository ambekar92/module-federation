    ...
    >
      ...
      <FormProvider {...methods}>
        ...
        {currentStep === Steps.ReviewSummary && 
           <ReviewSummary modalRef={modalRef} setCurrentStep={setCurrentStep} />
        }

        {currentStep === Steps.ApprovalLetter && 
          <ApprovalLetter modalRef={modalRef} setCurrentStep={setCurrentStep} />}
        
        {currentStep === Steps.DeclineLetter && <DeclineLetter modalRef={modalRef} setCurrentStep={setCurrentStep} />}
      </FormProvider>
