...
import { CompleteReviewFormType, DeclineLetterType, Steps } from '../types'
...
const DeclineLetter = ({ modalRef, setCurrentStep }: { modalRef: RefObject<ModalRef>, setCurrentStep: Dispatch<React.SetStateAction<number>> }) => {
    ...
    function onSubmit(formData: any) {
        ...
        // make an api call to save responses
