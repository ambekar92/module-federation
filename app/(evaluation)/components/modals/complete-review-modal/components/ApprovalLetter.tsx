...
import { ApprovalLetterType, CompleteReviewFormType, ReviewSummaryType, Steps } from '../types'
...
const ApprovalLetter: React.FC<ApprovalLetterProps> = ({
  ...
  const { approvedPrograms, approvedLetters, declinedPrograms, isLoading } = useProgramStatus(reviewSummaryData, analystDecisions);
