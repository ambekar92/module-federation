  ...
  const handlePostRequest = async () => {
    try {
      ...
      if (response.data) {
        ...
        setPostSuccess(true); // This line ensures postSuccess is set to true
    ...
    <>
      ...
      {postSuccess && (
        <ButtonGroup className='display-flex flex-justify margin-top-3'>
          <Button type='button' className={`${styles['field-title']}`} unstyled onClick={handleOpenModal}>Append Previous</Button>
          <Button type='button' className={`${styles['field-title']}`} unstyled onClick={handleOpenDeleteModal}>x Delete</Button>
        </ButtonGroup>
      )}
