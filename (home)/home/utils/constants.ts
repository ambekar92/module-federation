export const homeCarouselData = [
  {
    hero: 'Unified Certification Platform',
    para: 'Welcome to the Unified Certification Platform, your one-stop destination for all SBA certification requirements.',
    backgroundImg: '',
