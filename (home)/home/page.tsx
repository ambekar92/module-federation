...
const ParticipationAgreementModal = dynamic(
  () => import('../components/participation-agreement-modal/ParticipationAgreementModal'),
  { ssr: false }
);

const UserSessionModal = dynamic(
  () => import('@/app/shared/components/user-session-management-modal/UserSessionModal'),
  { ssr: false }
);
      ...
      <div className="tablet:grid-col-4 margin-top-4 tablet:margin-bottom-0">
        <nav aria-label="Side navigation,">
          <ul className="usa-sidenav">
            ...
            <li className="usa-sidenav__item">
              <Link href="/attestation">Question and Answer</Link>
            </li>
            <li className="usa-sidenav__item">
            ...
            <li className="usa-sidenav__item">
              <Link href="/user/firm/dashboard">Entity Dashboard</Link>
            </li>
            <li className="usa-sidenav__item">
              <Link href="/admin/document-types">Document Types</Link>
            </li>
            <li className="usa-sidenav__item">
              <Link href="/admin/document-categories">Document Categories</Link>
            </li>
            <li className="usa-sidenav__item">
            ...
            <li className="usa-sidenav__item">
              <Link href="/user/profile-settings/1">Profile</Link>
            </li>
            <li className="usa-sidenav__item">
