      ...
      {open === true && (
        ...
        >
          ...
          <div className={styles['modalBody']}>
            ...
            <div>
              <Label htmlFor="session-modal">Created by</Label>
              <TextInput
                id="createdby"
                name="createdby"
                type="text"
            ...
            <div>
              <Label htmlFor="session-modal">Introductory Paragraph</Label>
              <QuillEditorReact
                value={editorContent}
                  ...
                  return (
                    <div key={index}>
                      ...
                      <Textarea
                        id="description"
                        name="description"
                        className={`${styles.maxWidth} ${styles.maxHeight} ${styles['textarea']}`}
            ...
            <div>
              <Label htmlFor="session-modal">Closing Paragraph</Label>
              <QuillEditorReact
